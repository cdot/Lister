...
class ModelTest {
    ...
    fun testChecklistItem() {
        ...
        for (fl in ci.flagNames) {
            Assert.assertEquals(ChecklistItem.isDone, fl)
        }
        ci.setFlag(ChecklistItem.isDone)
        Assert.assertTrue(ci.getFlag(ChecklistItem.isDone))
        ci.clearFlag(ChecklistItem.isDone)
        Assert.assertFalse(ci.getFlag(ChecklistItem.isDone))
    ...
    fun testChecklist() {
        ...
        Assert.assertEquals(0, cli.checkedCount.toLong())
        ...
        cli.checkAll(true)
        Assert.assertTrue(cli.data[0].getFlag(ChecklistItem.isDone))
        Assert.assertTrue(cli.data[1].getFlag(ChecklistItem.isDone))
        cli.checkAll(false)
        Assert.assertFalse(cli.data[0].getFlag(ChecklistItem.isDone))
        Assert.assertFalse(cli.data[1].getFlag(ChecklistItem.isDone))
        cli.data[1].setFlag(ChecklistItem.isDone)
        ...
        Assert.assertTrue(cli2.data[0].getFlag(ChecklistItem.isDone))
        Assert.assertEquals("Row2", cli2.data[1].text)
        Assert.assertFalse(cli2.data[1].getFlag(ChecklistItem.isDone))
    }
    ...
    fun testChecklists() {
        ...
        Assert.assertEquals(TMP_FILE, clis.uRI)
        Assert.assertEquals(TMP_FILE, clis2.uRI)
